...
np.save(f"./saves/3p/lda_dwt_{len(pfm.ch_list)}_{maker.split_mode}/coef",coef)
np.save(f"./saves/3p/lda_dwt_{len(pfm.ch_list)}_{maker.split_mode}/intercept",intercept)
