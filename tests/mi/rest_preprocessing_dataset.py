...
session = scipy.io.loadmat(f"{root_path+p3_dir}/session1/sess{(1):02}_subj{(1):02}_EEG_MI.mat")
...
#%% restデータ統合
with h5py.File(root_path+"/test.h5",mode="w") as h5:
    if "rest" in h5:
        del h5["rest"]
